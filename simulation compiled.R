...
auction_engine <- function(timeSpan, Impression_target, spend_budget){
  ...
  bidders <- list(default1=bidder_base(spend_budget, Impression_target, 1, g, uniques, default(10, 0.4, 1.2), "default1"), 
                  ...
                  PID1 = bidder_base(spend_budget, Impression_target, 1, g, uniques, PID_base(payout = 1.2, margin = 0.4, k_1=0.2, k_2 = 0.0001, k_3=0.001, bid_requests, g=g, target=Impression_target), "PID1"),
                  PID2 = bidder_base(spend_budget, Impression_target, 1, g, uniques, PID_base(payout = 1.2, margin = 0.4, k_1=0.01, k_2 = 0.001, k_3=0.009, bid_requests, g=g, target=Impression_target), "PID2"))
...
results <- auction_engine(1, 150000, 105)
